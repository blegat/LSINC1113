\sessioncorrection{Intégrales multiples}
...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \[
        \begin{aligned}
            I = \int_1^2 (\frac{(2x -1) e^{2x} + 1}{x^2}) \, dx 
        \end{aligned}
        \]

        Or on peut y trouver une fonction et sa dérivée: 
        \[
        \begin{aligned}
            (\frac{e^{2x}}{x})^{'} = \frac{2 e^{2x} x - e^{2x}}{x^2}= \frac{(2x -1) e^{2x}}{x^2}
        \end{aligned}
        \]
        On a donc deux intégrale simple à calculer : 

        \[
        \begin{aligned}
           &\int_1^2 (\frac{2e^{2x}}{x} - \frac{e^{2x}}{x^2}) dx = \left[ \frac{e^{2x}}{x}\right]_1^2 = \frac{e^4}{2} - e^2 \\
           &\int_1^2 \frac{1}{x^2} dx = \left[ -\frac{1}{x}\right]_1^2 = \frac{1}{2} \\
           &I = \frac{1}{2}e^4 - e^2 + \frac{1}{2}        \end{aligned}
        \]
    \end{enumerate}
\end{solution}
...
\begin{solution}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=0.4\linewidth]{2025/2025_pic/exo3.png}
    \end{figure}
...
\begin{solution}
    ...
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{2025/2025_pic/exo4.png}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \[
        \begin{aligned}
...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[width=0.8\linewidth]{2025/2025_pic/exo5.png}
        \end{minipage}%
        \begin{minipage}{0.5\textwidth}
            \[
            \begin{aligned}
        ...
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[width=0.8\linewidth]{2025/2025_pic/exo52.png}
        \end{minipage}%
        \begin{minipage}{0.5\textwidth}
            \[
            \begin{aligned}
        ...
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[width=0.8\linewidth]{2025/2025_pic/exo53.png}
        \end{minipage}
        \begin{minipage}{0.5\textwidth}
            \[
            \begin{aligned}
        ...
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[width=0.8\linewidth]{2025/2025_pic/exo54.png}
        \end{minipage}
        \begin{minipage}{0.5\textwidth}
            \[
            \begin{aligned}
