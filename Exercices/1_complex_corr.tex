...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item $\ds z = (3)^4(\cis{(60^\circ)})^4 \\ 
        = 81 \cis{(60^\circ)}\cis{(60^\circ)}\cis{(60^\circ)}\cis{(60^\circ)} \\ 
        = 81 \cis{(240^\circ)}$
...
\begin{solution}
    ...
    \begin{multicols}{2}
        ...
        \item $\ds \overline{z} = 3 (\cos{120^\circ} - i \sin{120^\circ}) = 3 (\cos{-120^\circ} + i \sin{-120^\circ}) = 3 \cis{(-120^\circ)}$
...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        x = \pm 2i$
        \item $\ds 3x^2 - 4x + 2 = 0 \\
        x = \frac{-(-4) \pm \sqrt{-8}}{2(3)} = \frac{4 \pm \sqrt{8}i}{6} = \frac{2 \pm \sqrt{2}i}{3}$
        \item $\ds x^2 - 5ix - 6 = 0 \\
        x = \frac{-(-5i) \pm \sqrt{-1}}{2(1)} = \frac{5i \pm i}{2} \\
        x = 3i \quad \text{ou} \quad x = 2i$
...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item $\ds \frac{i+1}{2j} = \frac{1}{2} (1-i)$
