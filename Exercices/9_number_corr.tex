...
\begin{solution}
    ...
    On remonte les étapes pour écrire \( 1 \) comme combinaison linéaire de \( 3066 \) et \( 713 \).
    ...
    Le \( \text{pgcd}(3066, 713) = 1\). On peut donc remonter et appliquer le théorème d'Euclide étendu :\\
    \[ 
    \begin{aligned}
        1 &= 214 - 71 \cdot 3 \\
        1 &= 214 - (716 - 214 \cdot 3) \cdot 3 \\
        1 &= 214 \cdot 10 - 716 \cdot 3 \\
        1 &= (3066 - 716 \cdot 4) \cdot 10 - 716 \cdot 3 \\
        1 &= 3066 \cdot 10 - 716 \cdot 43 \\
    \end{aligned}
    \]
    On trouve donc \(q = -43\) et p \(p = 10\).
\end{solution}
...
\begin{solution}
    ...
    \begin{enumerate}
        \item Les conditions du théorème des restes Chinois \\
        $\rightarrow$ 7 et 9 sont premiers entre eux (\(\text{pgcd}(9,7) = 1 \)). Une solution unique existe donc \(7 \cdot 9 = 63\)
        
        \item \(x = a_1 \cdot N_{1} \cdot N_{1}^{-1} + a_2 \cdot N_{2} \cdot N_{2}^{-1}\)
        
        \item Calculs des inverses \\
        \(N_1 = \frac{63}{7} = 9 \pmod{7}\) $\rightarrow$ $9-7 \cdot 1 = 2$ \\
        $9 \equiv 2 \pmod{7}$ \\
        On cherche l'inverse de $2 \pmod{7}$. Pour se faire, on utilise Euclide étendu : \\
        \( 2 x + 7 k = 1 \rightarrow 7 = 2 \cdot 3 + 1\) \\
        On trouve donc finalement $x = -3$ et $k = 1$. \\
    
        \(N_1 = \frac{63}{9} = 7 \pmod{9}\) \\
        On ne sait pas réduire plus, \\
        On cherche l'inverse de $7 \pmod{9}$. Pour se faire, on utilise Euclide étendu : \\
        \(
        \begin{aligned}
...
\begin{solution}
    ...
    \begin{enumerate}
        \item Les conditions du théorème des restes Chinois \\
        $\rightarrow$ 71 et 97 sont premiers entre eux (\(\text{pgcd}(97,71) = 1 \)). Une solution unique existe donc \(71 \cdot 97 = 6887\)
        
        \item \(x = a_1 \cdot N_{1} \cdot N_{1}^{-1} + a_2 \cdot N_{2} \cdot N_{2}^{-1}\)
        
        \item Calculs des inverses \\
        \(N_1 = \frac{6887}{71} = 97 \pmod{71}\) $\rightarrow$ $97-71 \cdot 1 = 26$ \\
        $97 \equiv 26 \pmod{71}$ \\
        On cherche l'inverse de $26 \pmod{71}$. Pour se faire, on utilise Euclide étendu : \\
        \( 
        \begin{aligned}
            26 x + 71 k = 1 \rightarrow 5 - 2 \cdot 2 &= 1 \\
        ...
        On trouve donc finalement $x = -30$ mais qu'on rapporte à $x = 41 \pmod{71}$. \\
    
        \(N_2 = \frac{6887}{97} = 71 \pmod{97}\) $\rightarrow$ On ne sait pas réduire plus. \\
...
\begin{solution}
    \text{ } \\
    \[ x \equiv 4 \pmod{7} \text{ et } x \equiv 5 \pmod{8} \text{ et } x \equiv 11 \pmod{15} \]

    \begin{enumerate}
        \item Les conditions du théorème des restes Chinois \\
        $\rightarrow$ 7, 8 et 15 sont premiers entre eux (\(\text{pgcd}(7,8) = 1 \), \(\text{pgcd}(7,15) = 1 \) and \(\text{pgcd}(8,15) = 1 \)). Une solution unique existe donc \(7 \cdot 8 \cdot 15 = 840 \)

        \item \(x = a_1 \cdot N_{1} \cdot N_{1}^{-1} + a_2 \cdot N_{2} \cdot N_{2}^{-1} + a_3 \cdot N_{3} \cdot N_{3}^{-1}\)

        \item Calculs des inverses \\
        \(N_1 = \frac{840}{7} = 120 \pmod{7}\) $\rightarrow$ $120 - 7 \cdot 17 = 1$ \\
        $120 \equiv 1 \pmod{7}$ \\
        On cherche l'inverse de $1 \pmod{7}$. Pour se faire, on utilise Euclide étendu : \\
         \( 
        \begin{aligned}
        ...
        \(N_2 = \frac{840}{8} = 105 \pmod{8}\) $\rightarrow$ $105 - 8 \cdot 13 = 1$ \\
        $105 \equiv 1 \pmod{8}$ \\
        On cherche l'inverse de $1 \pmod{8}$. Pour se faire, on utilise Euclide étendu : \\
        \( 
        \begin{aligned}
        ...
        \(N_3 = \frac{840}{15} = 56 \pmod{15}\) $\rightarrow$ $56 - 15 \cdot 3 = 11$ \\
        $56 \equiv 11 \pmod{15}$ \\
        On cherche l'inverse de $11 \pmod{15}$. Pour se faire, on utilise Euclide étendu : \\
        \( 
        \begin{aligned}
