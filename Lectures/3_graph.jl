...
* Arbre de recherche:
  ...
  - ... $wooclap_ncols``{}^{\text{colonnes} \times \text{hauteur}} = `` $(replace(Formatting.format(big(wooclap_ncols)^(wooclap_nrows * wooclap_ncols), commas=true), "," => " ")) feuilles !
...
manifest_format = "2.0"
project_hash = "03f5c2d269236260f66a0736d08e183b4829e26e"
